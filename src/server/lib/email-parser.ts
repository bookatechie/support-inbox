...
/**
 * Check if email is likely auto-generated (bounce, out-of-office, etc.)
 */
export function isAutoGenerated(parsed: ParsedEmail): boolean {
  ...
  // Note: We intentionally don't filter all "noreply" addresses here
  // Many legitimate business emails (order confirmations, shipping notifications)
  // come from noreply addresses. We rely on pattern matching above for true auto-replies.
  // A whitelist/blacklist can be added later if needed.
